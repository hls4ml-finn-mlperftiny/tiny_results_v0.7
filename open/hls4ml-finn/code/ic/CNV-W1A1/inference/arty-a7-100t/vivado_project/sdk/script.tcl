...
if { $::argc == 1 } {
    ...
    configapp -app finn_cnv_w1a1_standalone -add linker-misc {-Wl,--defsym=_HEAP_SIZE=0x100000}
    configapp -app finn_cnv_w1a1_standalone -add linker-misc {-Wl,--defsym=_STACK_SIZE=0x100000}
}
