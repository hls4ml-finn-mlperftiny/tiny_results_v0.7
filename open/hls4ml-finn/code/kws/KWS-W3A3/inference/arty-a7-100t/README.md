...
make gui
```
6. This will pop up the SDK, close the "welcome" tab and you should have the baremetal app.
...
12. Open EEMBC runner GUI and and perform measurements, follow the instructions on the eembc README
