...
if { $::argc == 1 } {
    ...
    configapp -app finn_kws_mlp_w3a3_standalone -add linker-misc {-Wl,--defsym=_HEAP_SIZE=0x100000}
    configapp -app finn_kws_mlp_w3a3_standalone -add linker-misc {-Wl,--defsym=_STACK_SIZE=0x100000}
}
